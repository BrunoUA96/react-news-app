export const NewsCart = ({ isFirst = true }) => {
   return (
      <>
         <div className={`flex gap-3 cursor-pointer ${isFirst ? 'flex-col mb-8' : 'mb-5'}`}>
            {/* Image */}
            ...
            <div className="flex flex-col justify-between">
               <h5 className="text-base text-gray-800 font-bold mb-3">
         ...
         <div className={`flex gap-3 mb-5 cursor-pointer ${!isFirst && 'flex-col'}`}>
            {/* Image */}
            <div className="flex-shrink-0">
               <img
                  className={`object-cover ${!isFirst ? 'w-full max-h-52' : 'w-24 h-24'}`}
